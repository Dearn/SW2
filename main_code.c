		...
		extern void LCDClearScreen(void);
		 ...
		 // usart
		 extern void InitUSART0(void);
extern void InitUSART1(void);

extern void write_char_USART0(unsigned char);
extern unsigned char read_char_USART0(void);
void extern write_char_USART1(unsigned char);
extern unsigned char read_char_USART1(void);

extern void write_str_USART0(unsigned char* buff);
extern void write_str_USART1(unsigned char* buff);
...
unsigned char read_char_USART1_nonstop(void);
		...
		void beepString(const char beepstring[])
		{
			...
			while(im<sizeof(beepstring)){
				switch(beepstring[im])
				{
